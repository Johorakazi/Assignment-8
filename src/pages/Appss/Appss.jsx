...
const Apps = () => {
  ...
  const handleCardClick = (app) => {
    // ✅ Navigates to AppDetails page, sending selected app data
    ...
    <div className="px-10 py-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          <input
            ...
            className="input input-bordered w-60 p-2 border rounded-md"
          />
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          {/* ✅ Clickable Cards that lead to AppDetails */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8 justify-center px-10">
            {filteredApps.map((app) => (
              <div
                key={app.id}
                onClick={() => handleCardClick(app)} // ✅ Added click-to-detail navigation
                className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-transform hover:scale-[1.04] flex flex-col cursor-pointer"
              >
                <div className="p-4">
                ...
                <div className="flex justify-between items-center w-full px-4 pb-4">
                  ...
                  >
                    ...
                    {app.downloads
                      ? Math.round(app.downloads / 1e6) + "M"
                      : "N/A"}
                  </button>
